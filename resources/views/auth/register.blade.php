        ...
        <div class="row justify-content-center">
            <div class="col-md-5 mt-5">
                <div class="card  border-secondary"  style="background-color:black;">
                    <div class="card-header text-white">Kayıt Ol</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3 text-white">
                                <label for="username"
                                    class="col-md-4 col-form-label text-md-end">Kullanıcı Adı</label>
                            ...
                            <div class="row mb-3 text-white">
                                <label for="password-confirm"
                                    class="col-md-4 col-form-label text-md-end">Tekrar Şifre</label>
