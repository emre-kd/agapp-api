...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-R5GHGQDX5M"></script>
<script>
...
=============================== -->
                ...
                <div class="container-fluid position-relative h-100 flex-lg-column ps-3 px-lg-3 pt-lg-3 pb-lg-2 ">
                    ...
                    <div id="header-nav" class="collapse navbar-collapse w-100 my-lg-auto">
                        <ul class="navbar-nav text-lg-center my-lg-auto py-lg-3">
                            ...
                            @foreach ($headers->sortBy('sira') as $basliklar)
                                <li class="nav-item"><a class="nav-link smooth-scroll @once active @endonce"
                                        href="#{!! $basliklar->seo_url !!}">{!! $basliklar->name !!}</a></li>
                            @endforeach

                            <li class="nav-item"><a class="nav-link  " href="/en"><img style="width:30px;"
                                        src="/public/uk_flag.png" alt=""></a></li>
  ...
  ============================================= -->
    ...
    ============================================= -->
                        ...
                        <div class="container my-auto">
                            <div class="row">
                                <div class="col-12 text-center">
                                    ...
                                    <p class="text-7 fw-500 text-white mb-2 mb-md-3">{!! setting('site.welcome') !!}</p>
                                    <h2 class="text-16 fw-600 text-white mb-2 mb-md-3"><span class="typed"></span>
                                    </h2>
                                    <p class="text-5 text-light mb-4">{!! setting('site.welcome2') !!}</p>
                                    <a href="#iletisim"
                                        class="btn btn-outline-primary rounded-pill shadow-none smooth-scroll mt-2">{!! setting('site.button') !!}</a>
                                </div>
                            </div>
                        </div>
            ...
            <!-- About
    ============================================= -->
            <section id="hakkimizda" class="section bg-dark-1">
                <div class="container px-lg-5">
                    ...
                    <div class="row gy-5">
                        <div class="col-lg-7 col-xl-8 text-center text-lg-start">
                            <h2 class="text-7 text-white fw-600 mb-3">Ben <span
                                    class="text-primary">{!! setting('site.owner') !!}</span> </h2>
                            <p class="text-white-50">Merhaba ben Emre, 2000 yılında İstanbul'da doğdum ve burada
                                büyüdüm. İlk, ortaokul ve liseyi İstanbul'da tamamladıktan sonra Üniversite öğrenimi
                                için Burdur'a gittim, burada 4 sene kaldım. Lisans eğitimimi Mehmet Akif Ersoy
                                Üniversitesi - Yönetim Bilişim Sistemleri bölümünde tamamladım ve bu süre zarfında hem
                                teorik hem de pratik anlamda bilgilerimi geliştirdim.
                            </p>

                            <p class="text-white-50">Laravel, PHP, Bootstrap, JavaScript ve HTML/CSS gibi web
                                teknolojilerine olan ilgim nedeniyle, bu alanlarda kendimi geliştirerek uzmanlaşmaya
                                karar verdim. Laravel Framework'üne hakimiyetim, özellikle bazı backend projelerinde
                                başarılı sonuçlar elde etmemi sağladı. Ayrıca, proje yönetimi, takım çalışması, zaman
                                yönetimi ve problem çözme becerilerimi de geliştirdim. Laravel üzerinde 1 yıldan fazla
                                tecrübemle bazı canlı web projelerinde aktif görev aldım.
                            </p>
                    ...
                    <div class="my-projectss-grid separator-border separator-border-light mt-5">
                        <div class="row">
                            @foreach ($quadruples->sortBy('rule') as $dortlu)
            ...
            <!-- Services
    ============================================= -->
            <section id="beceriler" class="section bg-dark-2">
                <div class="container px-lg-5">
                    <!-- Heading -->
                    <div class="position-relative d-flex text-center mb-5">
                    ...
                    <div class="row">
                        <div class="col-lg-11 mx-auto">
                            <div class="row">
                                @foreach ($abilities as $beceriler)
                                    <div class="col-md-6">
            ...
            <!-- Resume
    ============================================= -->
            <section id="oz-gecmis" class="section bg-dark-1">
                <div class="container px-lg-5">
                    <!-- Heading -->
                    <div class="position-relative d-flex text-center mb-5">
                        <h2 class="text-24 text-muted opacity-1 text-uppercase fw-600 w-100 mb-0">
                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-md-6">
                            ...
                            @foreach ($resumes->sortBy('rule') as $ozgecmis)
                    ...
                    <div class="text-center mt-5"><a href="/public/CV.pdf" target="_blank"
            ...
            <!-- Portfolio
    ============================================= -->
            <section id="portfoy" class="section bg-dark-2">
                <div class="container px-lg-5">
                    <!-- Heading -->
                    <div class="position-relative d-flex text-center mb-5">
                        <h2 class="text-24 text-white-50 opacity-1 text-uppercase fw-600 w-100 mb-0">
                    ...
                    <ul class="portfolio-menu nav nav-tabs nav-light justify-content-center border-bottom-0 mb-5">
                        <li class="nav-item"> <a data-filter="*" class="nav-link active" href="">Hepsi</a>
                        </li>
                        ...
                        <li class="nav-item"> <a data-filter=".my-projects" href="" class="nav-link">Kendi
                                Projelerim</a></li>
                                ...
                                <div class="portfolio-box rounded">
                                    <div class="portfolio-img rounded"> <img style="height:200px; width:100%;"
                                        ...
                                        <div class="portfolio-overlay"> <a class="popup-ajax stretched-link"
                                                href="/public/tema/site/ajax/portfolio-ajax-project-dark-14.html"></a>
                                            <div class="portfolio-overlay-details">
                                                <h5 class="text-white fw-400">PHP ile anonim yorum sitesi </h5>
                                                <span class="text-light">Kendi Projelerim</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 col-lg-4  my-projects ">
                                <div class="portfolio-box rounded">
                                    <div class="portfolio-img rounded"> <img style="height:200px; width:100%;"
                                        ...
                                        <div class="portfolio-overlay"> <a class="popup-ajax stretched-link"
                                                href="/public/tema/site/ajax/portfolio-ajax-project-dark-16.html"></a>
                                            <div class="portfolio-overlay-details">
                                                <h5 class="text-white fw-400">Laravel ile gelişmiş yönetim paneli
                                                </h5>
                                                <span class="text-light">Kendi Projelerim</span>
                                            </div>
                                        </div>
                            ...
                            <div class="col-sm-6 col-lg-4  my-projects ">
                                <div class="portfolio-box rounded">
                                    <div class="portfolio-img rounded"> <img style="height:200px; width:100%;"
                                        ...
                                        <div class="portfolio-overlay"> <a class="popup-ajax stretched-link"
                                                href="/public/tema/site/ajax/portfolio-ajax-project-dark-17.html"></a>
                                            <div class="portfolio-overlay-details">
                                                <h5 class="text-white fw-400">Tek sayfalık responsive web site
                                                    şablonu
                                                </h5>
                                                <span class="text-light">Kendi Projelerim</span>
                                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4  my-projects ">
                                <div class="portfolio-box rounded">
                                    <div class="portfolio-img rounded"> <img style="height:200px; width:100%;"
                                        ...
                                        <div class="portfolio-overlay"> <a class="popup-ajax stretched-link"
                                                href="/public/tema/site/ajax/portfolio-ajax-project-dark-15.html"></a>
                                            <div class="portfolio-overlay-details">
                                                <h5 class="text-white fw-400">PHP ile yönetim paneli </h5>
                                                <span class="text-light">Kendi Projelerim</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-6 col-lg-4  my-projects ">
                                <div class="portfolio-box rounded">
                                    <div class="portfolio-img rounded"> <img style="height:200px; width:100%;"
                                        ...
                                        <div class="portfolio-overlay"> <a class="popup-ajax stretched-link"
                                                href="/public/tema/site/ajax/portfolio-ajax-project-dark-18.html"></a>
                                            <div class="portfolio-overlay-details">
                                                <h5 class="text-white fw-400">Laravel ve AJAX ile twitter klonu
                                                </h5>
                                                <span class="text-light">Kendi Projelerim</span>
                                            </div>
                                        </div>
                            ...
                            <div class="col-sm-6 col-lg-4  my-projects ">
                                <div class="portfolio-box rounded">
                                    <div class="portfolio-img rounded"> <img style="height:200px; width:100%;"
                                        ...
                                        <div class="portfolio-overlay"> <a class="popup-ajax stretched-link"
                                                href="/public/tema/site/ajax/portfolio-ajax-project-dark-19.html"></a>
                                            <div class="portfolio-overlay-details">
                                                <h5 class="text-white fw-400">PayTR entegrasyonlu boosting sitesi 
                                                </h5>
                                                <span class="text-light">Kendi Projelerim</span>
                                            </div>
                                        </div>
                            ...
                            <div class="col-sm-6 col-lg-4  my-projects ">
                                <div class="portfolio-box rounded">
                                    <div class="portfolio-img rounded"> <img style="height:200px; width:100%;"
                                        ...
                                        <div class="portfolio-overlay"> <a class="popup-ajax stretched-link"
                                                href="/public/tema/site/ajax/portfolio-ajax-project-dark-20.html"></a>
                                            <div class="portfolio-overlay-details">
                                                <h5 class="text-white fw-400">Laravel ve VueJs ile Google Drive klonu.
                                                </h5>
                                                <span class="text-light">Kendi Projelerim</span>
                                            </div>
                                        </div>
    ...
    ============================================= -->
            ...
            <!-- Contact Me
    ============================================= -->
            <section id="iletisim" class="section bg-dark-2">
                <div class="container px-lg-5">
                    <!-- Heading -->
                    <div class="position-relative d-flex text-center mb-5">
                        <h2 class="text-24 text-white-50 opacity-1 text-uppercase fw-600 w-100 mb-0">
